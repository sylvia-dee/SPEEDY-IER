...
C--   3.1 Initialize constants for isotope tracers
      if (iitest.eq.1) print*, 'calling INISO'
      CALL INISO()
...
C      if (iitest.eq.1) print*, 'calling SFC_IN'
C      CALL SFC_IN

C--   5.1 Initialize surface fluxes
